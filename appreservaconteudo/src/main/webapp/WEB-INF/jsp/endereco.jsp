...
<div class="form-group">
	...
	<input type="text" class="form-control" placeholder="Entre com o sua localidade" value="${endereco.localidade}" name="endereco.localidade">
</div>
<div class="form-group">
	<label>UF:</label>
	<input type="text" class="form-control" placeholder="Entre com o sua uf" value="${endereco.uf}" name="endereco.uf">
</div>